...
public class DynamicData implements Cloneable {
	 ...
	 * 0 � +126 : virage à droite jusqu'à 708° / min ou plus
	 * 0 � -126 : virage à gauche jusqu'à 708° / min ou plus
	 * 
	 ...
	 * ROTais est arrondie � la valeur entière la plus proche
	 * 
	...
	public String description() {
		return "<ul><h2>Données dynamiques</h2>"
				+ "<li>Status de navigation : "+navStat+"</li>"
				+ "<li>ROT : "+rot+"</li>"
				+ "<li>Vitesse fond : "+(double)(speed/10)+" kts</li>"
				+ "<li>Précision de position : "+(posAcc==1?"Elevée":"Peu élevée")+"</li>"
				+ "<li>Position : "+position.getLatitudeDouble()+", "+position.getLongitudeDouble()+"</li>"
				+ "<li>Route de fond : "+(double)(cog/10)+" °</li>"
				+ "<li>Cap vrai : "+trueHeading+" °</li>"
				+ "<li>Indicateur de manoeuvre particulière : "+specialManIndicator+"</li>"
				+ "<li>RAIM : "+(raim==0?"Non utilisé":"Utilisé")+"</li>"
				+ "</ul>";
	}
